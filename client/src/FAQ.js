...
<p><span>As a guideline, the idea is to recall the mnemonic and the answer or, if there is no specific answer, what the mnemonic is referring to. But you may wish to remember more detail. For example, you may be satisfied to remember that Christiaan Huygens was a Dutch astronomer who developed the wave theory of light (mnemonic: &lsquo;the universe has [huge ends] traversed by light waves&rsquo;). Or you may want to remember the additional details that Huygens studied the rings of Saturn and discovered its moon Titan and was an eminent 17th Century scientist in a range of areas.</span></p>

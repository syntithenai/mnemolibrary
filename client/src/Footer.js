...
export default class Footer extends Component {
	render() {
		let likeLink = encodeURIComponent('https://www.facebook.com/Mnemos-Library-258728258000790')
		let fullLink = 'https://www.facebook.com/plugins/like.php?href='+likeLink+'&width=121&layout=button_count&action=like&size=large&show_faces=false&share=false&height=65&appId=704362873350885'
        ...
        <nav className="nav">
          ...
          <iframe src={fullLink} width="121" height="25" style={{marginTop:'7px', paddingTop:'0px',border:'none',overflow:'visible'}} scrolling="no" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>

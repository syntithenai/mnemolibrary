...
//		console.log(this.discographyRef,this.discographyRef.innerHTML)
		...
		fetch('/api/importquestion', {
			  ...
			  body: JSON.stringify(Object.assign(result,{user:user,access:'public',interrogative:'Who is the musical artist ',question:that.getCanonicalName(result),difficulty:2,autoshow_image:"YES",answer:result.description,tags:result.extendedTags,type:'musician'}))
			}).then(function() {

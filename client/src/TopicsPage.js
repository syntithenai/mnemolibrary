            ...
            <div>
                ...
                {this.state.titleFilter.length>0 && <div><span>Search for &nbsp;
                  ...
                  <a className="btn btn-info" href="#"  onClick={() => this.props.setCurrentPage('search')}>Questions</a>&nbsp;instead.</span>
                    ...
                    <QuizList quizzes={this.state.topics} setQuizFromMissingMnemonic={this.props.setQuizFromMissingMnemonic} setQuiz={this.props.setQuizFromTopic} questionsMissingMnemonics={this.props.questionsMissingMnemonics} ></QuizList></div>}

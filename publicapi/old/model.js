...
module.exports.getClient = function(clientId, clientSecret) {
    ...
    //OAuthClientsModel.findOne({ clientId: clientId, clientSecret: clientSecret },function(err,res) {
        //console.log('found');
        //console.log(err);
   ...
   OAuthClientsModel.findOne({ clientId: clientId, clientSecret: clientSecret }).then(function(err,res) {
        console.log('found');
        console.log(err);
        // if (err) return console.error(err);
         console.log(res);
